...
- 선형대수, 컴퓨터과학개론, 프로그래밍언어론, 컴파일러구성은 교재 목차(`syllabus.yaml`)가 있어 챕터별 풀이를 지원합니다. 컴파일러구성은 워크북 문제(1~8장 315문제), 컴퓨터과학개론은 강의 연습문제(1~15강 65문제)까지 들어 있고, 나머지는 현재 기출만 있으며 강의·워크북 문제는 추후 추가합니다.
