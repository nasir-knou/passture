...
- 현재 카탈로그에는 1학기 5과목(운영체제, 이산수학, 알고리즘, 인공지능, Java프로그래밍)과 2학기 5과목(선형대수, 컴퓨터과학개론, 컴퓨터구조, 프로그래밍언어론, 컴파일러구성)이 등록되어 있습니다.
- 선형대수, 컴퓨터과학개론, 프로그래밍언어론, 컴파일러구성은 교재 목차(`syllabus.yaml`)가 있어 챕터별 풀이를 지원합니다. 컴파일러구성은 워크북 문제(1~8장 315문제), 컴퓨터과학개론은 강의 연습문제(1~15강 65문제), 선형대수는 강의 연습문제(1~15강 30문제)까지 들어 있고, 나머지는 현재 기출만 있으며 강의·워크북 문제는 추후 추가합니다.
